About quantlab_launcher-feedstock
=================================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/quantlab_launcher-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=5443&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/quantlab_launcher-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `quantlab_launcher` can be installed with `conda`:
...
```
mamba install quantlab_launcher
```

It is possible to list all of the versions of `quantlab_launcher` available on your platform with `conda`:
...
```
mamba search quantlab_launcher --channel conda-forge
```
...
mamba repoquery search quantlab_launcher --channel conda-forge

# List packages depending on `quantlab_launcher`:
mamba repoquery whoneeds quantlab_launcher --channel conda-forge

# List dependencies of `quantlab_launcher`:
mamba repoquery depends quantlab_launcher --channel conda-forge
```
